...
hypo2.1 <- hypothesis(model_data1, 'scaledx = 0')
hypo2.2 <- hypothesis(model_data2, 'scaledx = 0')
...
bf <- bayes_factor(model_data2, model_data2_null)

save.image('1modelVSsequential.RData')
hypothesis(model_data2, 'scaledx > 0')
hypothesis(model_data2, 'scaledx > 0')